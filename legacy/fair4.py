...
# Paths to the files that store the order of names and the current turn
REPO_PATH = Path(".")
NAMES_FILE = REPO_PATH / "names_order.txt"
TURN_FILE = REPO_PATH / "current_turn.txt"
PICK_FILE = REPO_PATH / "current_pick.txt"
